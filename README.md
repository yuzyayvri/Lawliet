...
[![Release](https://img.shields.io/github/v/release/yuzyayvri/Lawliet?style=for-the-badge)](https://github.com/yuzyayvri/Lawliet/releases)
[![License](https://img.shields.io/github/license/yuzyayvri/Lawliet?style=for-the-badge)](https://github.com/yuzyayvri/Lawliet/blob/main/LICENSE)
[![Language](https://img.shields.io/badge/language-C%2B%2B-00599C?style=for-the-badge)](#)
...
Go to the `build` directory in your terminal. After making the executable, you can use `./chess_app` to launch the mini chess sandbox, and `./chess_app --uci` to launch Lawliet with UCI.

Alternatively, if you have a GUI, point it towards the `chess_app` executable. Read your specific GUI's documentation if necessary.

## Thanks to

The GOAT, [Stockfish](https://github.com/official-stockfish/Stockfish), for heavy inspiration and NNUE. My god, implementing NNUE was hell. Lawliet, as of Lawliet Intuition 1.2, uses Stockfish 13's NNUE.
